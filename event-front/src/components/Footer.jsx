...
function Footer() {
    ...
    <footer >
        <div id="footer">
            <div id="announce">
                <h3 id="announce-title">S’abonner a <span>la newletters</span></h3>
                <p id="announce-info">Vous recevrez les nouvelles offres</p>
            </div>
            <form>
                    <input type="email" name="subscribe" id="subscribe" placeholder="Entrez votre email" /> 
                    <input type="button" value="S'abonner" id="btn-subscribe" />
            </form>
            <div id="contact">
                <p>Nous contactez -</p>
                <div id="contact-info">
                    ...
                    <div id="contact-info-socialmedia">   
                        <Link to='#'>
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
